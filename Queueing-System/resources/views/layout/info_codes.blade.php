            ...
            <div class="info-device">
                <div class="item-info-device">
                    <div class="text-info-device">
                        <p>Họ tên: </p><span>{{ $tickets->name }}</span>
                    </div>
                    <div class="text-info-device">
                        <p>Tên dịch vụ: </p><span>{{ $tickets->service_name }}</span>
                    </div>
                    <div class="text-info-device">
                        <p>Số thứ tự: </p><span>{{ $tickets->sequence_number }}</span>
                    </div>
                    <div class="text-info-device">
                        <p>Thời gian cấp: </p>
                        <span>{{ date('H:i - d/m/Y', strtotime($tickets -> issued_at)) }}</span>
                    </div>
                    <div class="text-info-device">
                        <p>Hạn sử dụng: </p>
                        <span>{{ date('H:i - d/m/Y', strtotime($tickets -> expired_at)) }}</span>
                    </div>
                </div>
                <div class="item-info-device">
                    <div class="text-info-device">
                        <p>Nguồn cấp: </p><span>{{ $tickets->source == 'system' ? 'Hệ thống' : 'Kiosk' }}</span>
                    </div>
                    <div class="text-info-device">
                        <p>Trạng thái: </p>
                    ...
                    <div class="text-info-device">
                        <p>Số điện thoại: </p><span>{{ $tickets->phone }}</span>
                    </div>
                    <div class="text-info-device">
                        <p>Địa chỉ Email: </p><span>{{ $tickets->email }}</span>
                    </div>
                </div>
            </div>
        </div>
