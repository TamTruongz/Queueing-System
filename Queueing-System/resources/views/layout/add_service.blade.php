    ...
    <div class="content-add-service">
        ...
        <div class="area-form-add-service">
            ...
            <form id="form-add-service"
                action="{{ isset($service->service_code) ? route('service.update', ['id' => $service->id]) : route('service.store') }}"
                method="POST">
                @csrf
                    ...
                    <div class="items-checkbox-service">
                        <div class="left-checkbox-service">
                            <input class="checkbox-service" type="checkbox" name="auto_increment" value="1"
                                id="auto_increment"
                                {{ isset($service->auto_increment) && $service->auto_increment == true ? 'checked' : '' }}>
                            <p>Tăng tự động từ:</p>
                        </div>
                    ...
                    <div class="items-checkbox-service">
                        <div class="left-checkbox-service">
                            <input class="checkbox-service" type="checkbox" name="prefix" value="1" id="prefix"
                                {{ isset($service->prefix) && $service->prefix == true ? 'checked' : '' }}>
                            <p>Prelix: </p>
                        </div>
                    ...
                    <div class="items-checkbox-service">
                        <div class="left-checkbox-service">
                            <input class="checkbox-service" type="checkbox" name="surfix" value="1" id="surfix"
                                {{ isset($service->surfix) && $service->surfix == true ? 'checked' : '' }}>
                            <p>Surfix: </p>
                        </div>
                    ...
                    <div class="items-checkbox-service">
                        <div class="left-checkbox-service">
                            <input class="checkbox-service" type="checkbox" name="reset_daily" value="1"
                                {{ (isset($service->reset_daily) && $service->reset_daily == true) ? 'checked' : '' }}>
                            <p>Reset mỗi ngày</p>
                        </div>
                    </div>
                </div>
