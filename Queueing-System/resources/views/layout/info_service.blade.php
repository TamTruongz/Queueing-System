...
<!-- <style>
    ...
    .button-update-back-info-service {
        position: absolute;
        top: 0;
        right: 0;
    ...
    .border-top-info-service {
        border-top: 2px solid #FFE3CD;
    }

    .content-info-service-left {
        width: 370px;
        height: 595px;
        background: #FFFFFF;
        box-shadow: 2px 2px 8px rgba(232, 239, 244, 0.8);
        border-radius: 12px;
        padding: 16px;
    }

    .content-info-service-left h2 {
        font-weight: 700;
        font-size: 20px;
        line-height: 30px;
        color: #FF7506;
    ...
    .area-filter-info-service {
        display: flex;
        justify-content: space-between;
    }

    .btn-select-info-service {
        width: 160px;
        height: 44px;
        background: #FFFFFF;
    ...
    .search-info-service::placeholder {
        font-weight: 400;
        font-size: 16px;
        line-height: 22px;
        color: #A9A9B0;
    ...
    .table-info-service table thead tr th {
        width: 50%;
    }
</style> -->
<main>
                ...
                <div class="menu-info-service">
                    <div class="area-filter-info-service">
                        <div class="dropdown status-device">
                            ...
                            <button class="btn-select-info-service" role="button" id="dropdownMenuStatusDevice" data-bs-toggle="dropdown" aria-expanded="false"> Tất cả
                            ...
                            <ul class="dropdown-menu list-status-active-info-service" aria-labelledby="dropdownMenuStats">
