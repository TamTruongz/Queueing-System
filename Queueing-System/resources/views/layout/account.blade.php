        ...
        <div class="menubar-device">
            <div class="area-filter">
                <div class="dropdown status-device">
                    <p class="text-status-device">Tên vai trò</p>
                    <a class="btn-select-device" href="#" role="button" id="dropdownRole" data-bs-toggle="dropdown"
                    ...
                    <ul class="dropdown-menu list-status-active-device" aria-labelledby="dropdownRole">
                        <li>
                            <a class="dropdown-item item-date-stats" href="#">Tất cả</a>
                        </li>
                        <li><a class="dropdown-item item-date-stats" href="#">Hoạt động</a></li>
                        <li><a class="dropdown-item item-date-stats active-date-stats" href="#">Ngừng hoạt động</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border-table">
                            ...
                            {{ ($account -> status) == true ? 'Hoạt động' : 'Ngưng hoạt động'}}
                        </td>
