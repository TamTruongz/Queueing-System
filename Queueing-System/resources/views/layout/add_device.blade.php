...
<main>
    <div class="content-add-device">
        ...
        <div class="area-form-add-device">
            ...
            <form class="form-add-device" action="" method="">
                ...
                <div class="item-form-add-device">
                    ...
                    <div class="dropdown">
                        <a class="input-choose-device" href="#" role="button" id="dropdownChooseAddDevice" data-bs-toggle="dropdown" aria-expanded="false"> Chọn loại thiết bị
                        ...
                        <ul class="dropdown-menu list-choose-device" aria-labelledby="dropdownChooseAddDevice">
                ...
                <div class="item-form-add-device">
                    ...
                    <input class="input-user-device" type="text" placeholder="Nhập dịch vụ sử dụng">
                </div>
        ...
        <div class="area-button-add_device">
            ...
            <button class="btn-add-device-add" type="button">Thêm thiết bị</button>
        </div>
    </div>
</main>
@endsection